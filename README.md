...
نسخه جدید سیستم پرداخت، واریزا را به‌صورت رسمی و سروری پشتیبانی می‌کند:

- فعال/غیرفعال کردن جداگانه کارت‌به‌کارت و واریزا از وب‌پنل و پنل مدیریت تلگرام
- تغییر نام دکمه هر روش پرداخت
- ساخت لینک پرداخت واریزا برای شارژ کیف پول و خرید سرویس
- تأیید خودکار از طریق Webhook امضاشده HMAC-SHA256
- تطبیق پرداخت با `slug` اختصاصی و نه مبلغ؛ بنابراین تغییر جزئی مبلغ واریزا باعث خطای تطبیق نمی‌شود
- جلوگیری از دوباره‌پرداخت شدن Webhookهای تکراری

### تنظیم واریزا

در وب‌پنل از بخش **مالی → کارت‌ها**:

1. آدرس عمومی HTTPS سرور را وارد کنید.
2. API Key واریزا و Webhook Secret را وارد کنید.
3. واریزا را فعال کنید.
4. آدرس نمایش‌داده‌شده در بخش Webhook را در پروفایل واریزا به‌عنوان `callback_url` ثبت کنید.

مستندات رسمی API واریزا: https://variza.ir/developers
